...
UPDATE produtos SET nome = 'Coca Cola lata' WHERE nome = 'Coca Cola Lata';
UPDATE produtos SET nome = 'Coca Cola 2L' WHERE nome = 'Coca 2L';

INSERT INTO produtos (nome, preco, categoria_id) VALUES
('Guaraná Antarctica Lata', 5.00, (SELECT id FROM categorias WHERE nome = 'Bebidas')),
('Fanta Uva/Laranja Lata', 5.00, (SELECT id FROM categorias WHERE nome = 'Bebidas')),
('Água Tônica', 6.00, (SELECT id FROM categorias WHERE nome = 'Bebidas')),
('Limoneto 500 ml', 8.00, (SELECT id FROM categorias WHERE nome = 'Bebidas'));


UPDATE produtos SET nome = 'Guaraná Antarctica lata' WHERE nome = 'Guaraná Antarctica Lata';
UPDATE produtos SET nome = 'Fanta Uva/Laranja lata' WHERE nome = 'Fanta Uva/Laranja Lata';

SELECT nome, preco FROM produtos WHERE categoria_id = (SELECT id FROM categorias WHERE nome = 'Bebidas') ORDER BY nome;